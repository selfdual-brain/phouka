...
import com.selfdualbrain.gui_framework.layout_dsl.StaticFieldListPanel
...
class ExperimentConfigView extends PanelView[PhoukaConfig, Nothing] with StaticFieldListPanel {
