  ...
  class TableDef(simulationDisplayModel: SimulationDisplayModel) extends SmartTable.Model {
    ...
    override val columns: Array[ColumnDefinition[_]] = Array(
      ...
      ColumnDefinition[Long](
        ...
        cellValueFunction = (rowIndex: Int) => model.perValidatorStats(rowIndex).allBricksReceived,
        textAlignment = TextAlignment.RIGHT,
        cellBackgroundColorFunction = None,
        preferredWidth = 50,
        maxWidth = 100
      ...
      ColumnDefinition[Long](
        ...
        runtimeClassOfValues = classOf[Long],
        cellValueFunction = (rowIndex: Int) => model.simulationStatistics.numberOfVisiblyFinalizedBlocks - model.perValidatorStats(rowIndex).lengthOfLfbChain,
        textAlignment = TextAlignment.RIGHT,
        cellBackgroundColorFunction = None,
        preferredWidth = 30,
        maxWidth = 100
      ...
      ColumnDefinition[Long](
        ...
        runtimeClassOfValues = classOf[Long],
        cellValueFunction = (rowIndex: Int) => model.perValidatorStats(rowIndex).ownBlocksPublished,
        textAlignment = TextAlignment.RIGHT,
        cellBackgroundColorFunction = None,
        preferredWidth = 40,
        maxWidth = 100
      ...
      ColumnDefinition[Long](
        ...
        runtimeClassOfValues = classOf[Long],
        cellValueFunction = (rowIndex: Int) => model.perValidatorStats(rowIndex).ownBallotsPublished,
        textAlignment = TextAlignment.RIGHT,
        cellBackgroundColorFunction = None,
        preferredWidth = 40,
        maxWidth = 100
      ...
      ColumnDefinition[Double](
        ...
        runtimeClassOfValues = classOf[Double],
        cellValueFunction = (rowIndex: Int) => model.perValidatorStats(rowIndex).ownBlocksAverageLatency,
        decimalRounding = Some(2),
        textAlignment = TextAlignment.RIGHT,
        cellBackgroundColorFunction = None,
        preferredWidth = 60,
      ...
      ColumnDefinition[Double](
        ...
        runtimeClassOfValues = classOf[Double],
        cellValueFunction = (rowIndex: Int) => model.perValidatorStats(rowIndex).ownBlocksThroughputBlocksPerSecond * 3600,
      ...
      ColumnDefinition[Double](
        ...
        runtimeClassOfValues = classOf[Double],
        cellValueFunction = (rowIndex: Int) => model.perValidatorStats(rowIndex).ownBlocksOrphanRate * 100,
        decimalRounding = Some(3),
        textAlignment = TextAlignment.RIGHT,
        cellBackgroundColorFunction = None,
        preferredWidth = 60,
      ...
      ColumnDefinition[Int](
        ...
        runtimeClassOfValues = classOf[Int],
        cellValueFunction = (rowIndex: Int) => model.perValidatorStats(rowIndex).numberOfObservedEquivocators,
        textAlignment = TextAlignment.RIGHT,
        cellBackgroundColorFunction = None,
        preferredWidth = 30,
        maxWidth = 100
