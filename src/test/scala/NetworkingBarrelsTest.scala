...
//  val disruptionModelCfg: DisruptionModelConfig = DisruptionModelConfig.VanillaBlockchain
  ...
  val downloadBandwidthModel: DownloadBandwidthModel[BlockchainNode] =
  ...
  val recorder: TextFileSimulationRecorder[BlockchainNode] = TextFileSimulationRecorder.withAutogeneratedFilename(new File("/home/wojtek/tmp/phouka"), eagerFlush = true, None)
